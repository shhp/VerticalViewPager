...
public class VerticalViewPager extends ScrollView {
    ...
    /**
     * {@link OnPageChangeListener#onPageSelected(int)} will be called whenever a different page is selected.
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final FrameLayout.LayoutParams lp = (LayoutParams) mRootContainer.getLayoutParams();
